...
export default function HomePage() {
  return (
    <div>
      {/* Hero Section */}
      <section className="relative min-h-[90vh] flex items-center justify-center bg-gradient-to-b from-reba-dark via-reba-card to-reba-dark">
        <div className="absolute inset-0 bg-gradient-to-br from-reba-pink/5 to-transparent" />
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <h1 className="font-[family-name:var(--font-heading)] text-6xl sm:text-8xl lg:text-9xl text-reba-cream mb-6">
            Sweet Reba&apos;s
          </h1>
          <p className="text-xl sm:text-2xl text-reba-soft mb-2 tracking-wide">
            Artisan Bakery. Made with Love Since 2004.
          </p>
          <p className="text-reba-muted mb-10">
