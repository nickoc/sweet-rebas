...
export const menuItems: MenuItem[] = [
  ...
  { id: "sandwich-cookies", name: "Sandwich Cookies", description: "Two buttery cookies with a generous swirl of cream filling. Rotating flavors weekly.", price: 4.00, category: "cookies", emoji: "🍪", available: 12 },
  ...
  { id: "soup-12oz", name: "Soup (12oz)", description: "Rotating daily soup — today's selection: tomato basil bisque. Made fresh each morning.", price: 5.00, category: "soup", emoji: "🥣", available: 24 },
