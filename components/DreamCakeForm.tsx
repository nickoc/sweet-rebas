    ...
    return (
      <div className="text-center mt-6">
        <div className="bg-white border border-reba-pink/30 rounded-2xl p-8 max-w-lg mx-auto">
          ...
          <h3 className="font-[family-name:var(--font-heading)] text-2xl text-reba-ink mb-2">
  ...
  return (
    <div className="mt-6 max-w-lg mx-auto">
      <div className="bg-white border border-reba-pink/30 rounded-2xl p-8">
        <h3 className="font-[family-name:var(--font-heading)] text-2xl text-reba-ink mb-1">
          Tell Us About Your Dream Cake
        </h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-reba-card border border-reba-border rounded-lg px-4 py-2.5 text-sm text-reba-ink placeholder:text-reba-muted focus:outline-none focus:border-reba-pink transition"
              />
            </div>
            <div>
              <label className="block text-reba-ink text-sm font-medium mb-1">Email</label>
              <input
                type="email"
                required
                value={form.contact}
          ...
          <div>
            <label className="block text-reba-ink text-sm font-medium mb-1">Event Date</label>
            <input
              type="date"
              value={form.date}
              onChange={(e) => setForm({ ...form, date: e.target.value })}
              className="w-full bg-reba-card border border-reba-border rounded-lg px-4 py-2.5 text-sm text-reba-ink focus:outline-none focus:border-reba-pink transition"
            />
          </div>
          <div>
            <label className="block text-reba-ink text-sm font-medium mb-1">Tell Us About Your Dream Cake</label>
            <textarea
              required
              rows={4}
              ...
              className="w-full bg-reba-card border border-reba-border rounded-lg px-4 py-2.5 text-sm text-reba-ink placeholder:text-reba-muted focus:outline-none focus:border-reba-pink transition resize-none"
            />
          </div>
          <button
            type="submit"
