...
export default function Footer({
  ...
  const doorDashUrl = contact.doordash;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-4 flex-1 bg-reba-card border-2 border-reba-pink/30 rounded-2xl p-6 text-center flex flex-col">
              ...
              <p className="text-reba-muted text-lg mt-1">{contact.carmelAddress}{" · "}{contact.carmelPhone}</p>
              <div className="border-t border-reba-border mt-4 pt-4 flex-1 flex flex-col justify-center">
                ...
                <p className="text-reba-pink text-lg italic">{contact.carmelStatus}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-4 flex-1 bg-reba-card border-2 border-reba-pink/30 rounded-2xl p-6 text-center flex flex-col">
              ...
              <p className="text-reba-muted text-lg mt-1">{contact.salinasAddress}{" · "}{contact.salinasPhone}</p>
              <div className="border-t border-reba-border mt-4 pt-4 flex-1 flex flex-col justify-center">
                <h4 className="font-[family-name:var(--font-heading)] text-2xl text-reba-ink mb-2">
                  Opening Hours
                </h4>
